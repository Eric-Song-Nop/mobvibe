...
<body>
  <div class="container">
    <div class="card">
      <div class="logo">
        <svg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" width="48" height="48" style="vertical-align:middle;margin-right:8px"><circle cx="128" cy="128" r="112" fill="none" stroke="#fdc700" stroke-width="14"/><path d="M 76,186 V 70 C 86,70 106,200 128,128 C 150,56 170,70 180,70 V 186" fill="none" stroke="#18181b" stroke-width="22" stroke-linecap="round" stroke-linejoin="round"/></svg>
