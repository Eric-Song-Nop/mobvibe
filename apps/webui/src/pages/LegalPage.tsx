			...
			<nav className="grid gap-2">
				{sections.map((section) => (
					<a
						...
						className="rounded-none border bg-muted/30 px-3 py-2 text-xs leading-5 text-muted-foreground transition-colors hover:border-primary/40 hover:text-foreground focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
					>
						{section.title}
					</a>
				))}
...
function LocaleArticle({
	...
	return (
		<article className="rounded-none border bg-background/96 p-5 shadow-sm backdrop-blur sm:p-6">
			...
			<div className="grid gap-4">
				{sections.map((section, index) => (
					<section
						...
						className="scroll-mt-6 rounded-none border bg-muted/20 p-4"
					>
						<div className="space-y-3">
